sap.ui.define([
    ...
    return BaseController.extend("project1.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("BusinessPartnerFullName", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "project1.view.ViewSettingsDialog",
                    controller: this
        ...
        _createViewModel: function() {
            return new JSONModel({
                ...
                sortBy: "BusinessPartnerFullName",
                groupBy: "None"
            });
        },
